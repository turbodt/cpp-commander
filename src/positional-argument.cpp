...
const std::regex PositionalArgument::label_regex =
    std::regex(PositionalArgument::label_regex_str);
...
bool PositionalArgument::has_value() const { return this->value_has_been_set; }
